...
describe('just for test inspector', () => {
    ...
    it('New noteBook - INFO', async () => {
        ...
        //     await driver.pause(5000); // Pause for 3 second
        //     await driver.touchAction([ //Scroll down(for xPath)
        //     { action: 'longPress', x: 0, y: 350 },
        //     { action: 'moveTo', x: 0, y: 2200 },
        //     'release'
        // ])
    })
})